...
public partial class Duan1Context : DbContext
{
    ...
    public string connectiongString() { return "Data Source=DESKTOP-R02JEAF\\VUHOPE;Initial Catalog=DUAN1;Integrated Security=True;Encrypt=True;Trust Server Certificate=True"; }
